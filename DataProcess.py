...
def AgriLoan():
	os.system("python AgriLoan.py")
def Fertilizer():
	os.system("python Fertilizer.py")
def Plantation():
	os.system("python Plantation.py")
def SoilData():
	os.system("python SoilData.py")
def Rainfall():
...
root.title("Data Process")
root.config(bg='lightblue')

hlab1 = tk.Label(root, text ='DATA PROCESS CENTER' )
